...
import FBook from '../assets/favoritebook.jpg'
  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        <div className='md:w-1/2'>
            <img src={FBook} alt='' className='rounded md:w-10/12'/>
        </div>
        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <p className='md-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga eos quod optio, repellat rem velit non sapiente eveniet quasi beatae?Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur, iusto!</p>
